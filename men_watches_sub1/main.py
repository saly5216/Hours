...
# Hardcoded subcategory URLs for Men's Watches
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/electronics/smart-watches/l/",
    "https://www.boutiqaat.com/ar-kw/men/watches/sports-watches/l/",
    "https://www.boutiqaat.com/ar-kw/men/watches/fashion-watches/l/",
    "https://www.boutiqaat.com/ar-kw/men/watches/fine-watches/l/",
    "https://www.boutiqaat.com/ar-kw/men/fashion-tech/smartwatch-accessories/l/",
    "https://www.boutiqaat.com/ar-kw/men/electronics/kids-watches/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Watches Pipeline (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/watches/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/watches/excel-files"
            )
